PatchScale_UniT<-function(x,path=NULL,years,nafo,Species,age,convert=24950.144,TempData,SaveIm=TRUE){
  ...
  PatchContact=cbind(PatchContact,rep("XC(t)",NROW(PatchContact)))
